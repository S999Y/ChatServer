...
public class AES {
    ...
    private byte[] encrypt(byte[] text) {
        ...
        // to store the state matrix in the steps
    ...
    // method to generate the iv vector
    public byte[] getIV() {
        String iv = "";
        for (int i = 0; i < 2; i++)
            iv += Long.toHexString(Double.doubleToLongBits(Math.random()));
        return iv.getBytes();
    }

    public void setSteps(LinkedList<stateRecord> steps) {
        this.steps = steps;
    }

    public LinkedList<stateRecord> getSteps() {
        return this.steps;
    }

    public void setDecryptionSteps(LinkedList<stateRecord> decryption) {
        this.decryption = decryption;
    }

    public LinkedList<stateRecord> getDecryptionSteps() {
    ...
    public String matrixToHexString(int[][] matrix) {
